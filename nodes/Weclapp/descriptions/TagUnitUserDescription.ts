...
export const customAttributeDefinitionFields: INodeProperties[] = [
	...
	// ── Create — required fields ───────────────────────────────────────────────
	{
		...
		required: true,
		default: 'article',
		description: 'The weclapp entity type this attribute applies to',
		displayOptions: {
		...
		routing: { send: { type: 'body', property: 'entityName' } },
	},
	{
	...
	},
	{
		...
		options: [
			...
			{ name: 'List (Multiple)', value: 'LIST_MULTI' },
			{ name: 'List (Single)', value: 'LIST_SINGLE' },
			{ name: 'Party Reference', value: 'PARTY_REFERENCE' },
